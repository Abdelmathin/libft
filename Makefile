...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2023/06/26 16:01:57 by ahabachi          #+#    #+#              #
#    Updated: 2023/06/26 17:18:07 by ahabachi         ###   ########.fr        #
#                                                                              #
#  **************************************************************************  #
#                                                                              #
#   █████████            ██████████         ██████████         ██████████      #
...
# 	@git commit -m "committed on '`date`' by '`whoami`', hostname = '`hostname`'"
	@git commit -m "by '`whoami`', hostname = '`hostname`', on '`date`'"
	@git push
